...
public class AddDataOleholeh extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        progressDialog = new ProgressDialog(AddDataOleholeh.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), KelolaOleholehActivity.class));
                finish();
            }
        });
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("oleh-oleh");
    ...
    public void UploadImage() {
        ...
        if (FilePathUri != null) {
            ...
            Toast.makeText(AddDataOleholeh.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
