...
public class AddDataCagarBudaya extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        progressDialog = new ProgressDialog(AddDataCagarBudaya.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), KelolaCagarbudayaActivity.class));
                finish();
            }
        });
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("cagar_budaya");
    ...
    public void UploadImage() {
        ...
        if (FilePathUri != null) {
            ...
            Toast.makeText(AddDataCagarBudaya.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
