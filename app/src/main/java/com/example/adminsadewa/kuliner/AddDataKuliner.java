...
public class AddDataKuliner extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        progressDialog = new ProgressDialog(AddDataKuliner.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), KelolaKulinerActivity.class));
                finish();
            }
        });
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("kuliner");
    ...
    public void UploadImage() {
        ...
        if (FilePathUri != null) {
            ...
            Toast.makeText(AddDataKuliner.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
