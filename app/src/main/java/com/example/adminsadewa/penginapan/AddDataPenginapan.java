...
import com.example.adminsadewa.cagarbudaya.KelolaCagarbudayaActivity;
...
public class AddDataPenginapan extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        progressDialog = new ProgressDialog(AddDataPenginapan.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), KelolaPenginapanActivity.class));
                finish();
            }
        });
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Penginapan");
    ...
    public void UploadImage() {
        ...
        if (FilePathUri != null) {
            ...
            Toast.makeText(AddDataPenginapan.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
