...
public class AdapterKuliner extends FirebaseRecyclerAdapter<User, AdapterKuliner.MyViewHolder> {


    public AdapterKuliner(@NonNull FirebaseRecyclerOptions<User> options) {
        super(options);
    }
            ...
            public void onClick(View view) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("kuliner")
