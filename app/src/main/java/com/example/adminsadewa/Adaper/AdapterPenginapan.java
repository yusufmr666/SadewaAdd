...
public class AdapterPenginapan extends FirebaseRecyclerAdapter<User, AdapterPenginapan.MyViewHolder> {


    public AdapterPenginapan (@NonNull FirebaseRecyclerOptions<User> options) {
        super(options);
    }
            ...
            public void onClick(View view) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Penginapan")
