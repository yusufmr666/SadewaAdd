...
public class AdapterOleholeh extends FirebaseRecyclerAdapter<User, AdapterOleholeh.MyViewHolder> {


    public AdapterOleholeh (@NonNull FirebaseRecyclerOptions<User> options) {
        super(options);
    }
            ...
            public void onClick(View view) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("oleh-oleh")
