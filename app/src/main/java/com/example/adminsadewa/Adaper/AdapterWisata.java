...
public class AdapterWisata extends FirebaseRecyclerAdapter<User, AdapterWisata.MyViewHolder> {


    public AdapterWisata(@NonNull FirebaseRecyclerOptions<User> options)
    {
        super(options);
    }
